...
public class BoatDA
{
   ...
   static String phoneNo;
	...
	public static Boat find(String key) throws NotFoundException
	{
		...
		// define the SQL query statement using the state reg key
	...
	public static Vector getAll()
	{
		...
		String sqlQuery = "SELECT StateRegistrationNo, BoatLength, " +
						  		"Manufacturer, Year FROM BoatTable";
		try
 		{
		 	// execute the SQL query statement
	    	ResultSet rs = aStatement.executeQuery(sqlQuery);
			boolean moreData = rs.next();	// next method sets cursor &
