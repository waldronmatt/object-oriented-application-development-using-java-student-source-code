...
public class MainMenu extends JFrame implements ActionListener
{
	...
	public MainMenu()
	{
		...
		findCustomerButton = new JButton("Find a Customer & Boat"); 
   ...
   public void actionPerformed(ActionEvent e)
   {
	...
	{
		FindCustomerAndBoat findCustomerFrame = new FindCustomerAndBoat(this);
		findCustomerFrame.setSize(450,175);     
		findCustomerFrame.setTitle("Find A Customer and Boat");
